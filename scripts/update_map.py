...
# Model transport lives in llm.py: the frontier watch needs the same two
# routes and the same tolerance for almost-JSON. With no key at all the run
# still writes verified edges and says in the digest that judgement was
# skipped.
from llm import have_model, claude, json_array as _json_array
